...
//   • AUTH_METHOD=local (default) — users with a password managed by the admin
//     in the admin console (lib/user-store.js).
//   • AUTH_METHOD=oidc — users via an OIDC provider (routes/auth.js).
